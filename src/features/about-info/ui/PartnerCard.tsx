...
import {Partner} from "@/features/about-info";
  ...
  return (
    <div className={"flex flex-col gap-2 items-center justify-center"}>
      <div className={clsx("relative group rounded-2xl overflow-hidden", props.classname)}>
        <ImageLoader imagePath={props.partner.partnerLogo} className="w-full"/>
        ...
        >
          <p className="text-bodyS_regular text-base-0 text-center p-2">
            {props.partner.partnerDescription}
          </p>
        </div>
      </div>
      ...
      {isDeleteModalOpen && (
        <Modal>
          ...
          <p className={"text-bodyM_regular text-blue-90"}>{props.partner.partnerDescription}</p>
